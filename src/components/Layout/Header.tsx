        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 lg:h-16">
            ...
            <motion.button
              ...
              className="md:hidden p-3 rounded-2xl bg-white/20 backdrop-blur-xl hover:bg-white/30 transition-all duration-200 flex-shrink-0 flex items-center justify-center"
            >
